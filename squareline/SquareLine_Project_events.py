...
def changeStratagem(event_struct):
    return


def selectStratagem(event_struct):
    return


def deselectStratagem(event_struct):
    return


def resetStratagems(event_struct):
    return


def triggerStratagem1(event_struct):
    return


def triggerStratagem2(event_struct):
    return


def triggerStratagem3(event_struct):
    return


def triggerStratagem4(event_struct):
    return


def backSetup(event_struct):
    return


def triggerStratagem5(event_struct):
    return


def triggerStratagem6(event_struct):
    return


def triggerStratagem7(event_struct):
    return


def triggerStratagem8(event_struct):
    return
...
def triggerStratagemUser5(event_struct):
    return
