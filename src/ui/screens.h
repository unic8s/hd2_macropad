...
typedef struct _objects_t {
    ...
    lv_obj_t *cnt_usr_stg_lst;
    lv_obj_t *cnt_usr_stg_seq1;
    lv_obj_t *seq_ico1;
    lv_obj_t *seq_cmd1_1;
    lv_obj_t *seq_cmd1_2;
    lv_obj_t *seq_cmd1_3;
