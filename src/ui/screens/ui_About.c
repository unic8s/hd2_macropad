...
void ui_About_screen_init(void)
{
    ...
    ui_LblVersion = lv_label_create(ui_SetupFooter3);
    lv_obj_set_width(ui_LblVersion, 232);
    lv_obj_set_height(ui_LblVersion, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_LblVersion, -253);
    lv_obj_set_y(ui_LblVersion, 231);
    ...
    lv_obj_set_style_text_align(ui_LblVersion, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
