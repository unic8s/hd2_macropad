...
void ui_Setup_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_BarAmount, lv_color_hex(0x979014), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_LabelAmount = lv_label_create(ui_Setup);
    ...
    lv_obj_set_y(ui_LabelAmount, 140);
