...
lv_obj_t * ui_StationaryGB;
void ui_event_StationarySS(lv_event_t * e);
lv_obj_t * ui_StationarySS;
lv_obj_t * ui_Strike;
...
const lv_img_dsc_t * ui_imgset_623321993[1] = {&ui_img_2107362454};
const lv_img_dsc_t * ui_imgset_623321992[1] = {&ui_img_986101477};
...
const lv_img_dsc_t * ui_imgset_en[2] = {&ui_img_sg_en1_png, &ui_img_sg_en2_png};
...
const lv_img_dsc_t * ui_imgset_gb[2] = {&ui_img_sg_gb1_png, &ui_img_sg_gb2_png};
...
const lv_img_dsc_t * ui_imgset_gdk[2] = {&ui_img_sg_gdk1_png, &ui_img_sg_gdk2_png};
...
const lv_img_dsc_t * ui_imgset_hp[2] = {&ui_img_sg_hp1_png, &ui_img_sg_hp2_png};
...
const lv_img_dsc_t * ui_imgset_otf[2] = {&ui_img_sg_otf1_png, &ui_img_sg_otf2_png};
...
const lv_img_dsc_t * ui_imgset_sg[2] = {&ui_img_sg_sg1_png, &ui_img_sg_sg2_png};
...
const lv_img_dsc_t * ui_imgset_ss[2] = {&ui_img_sg_ss1_png, &ui_img_sg_ss2_png};
...
void ui_event_BtnConfig(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Config, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 1000, 0, &ui_Config_screen_init);
    }
}
...
void ui_event_BtnPreset1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SHORT_CLICKED) {
        GetPreset(e);
        PresetLoadAnim_Animation(ui_BtnPreset1, 0);
    }
    if(event_code == LV_EVENT_LONG_PRESSED) {
        SetPreset(e);
        PresetSaveAnim_Animation(ui_BtnPreset1, 0);
    }
}
...
void ui_event_BtnPreset2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SHORT_CLICKED) {
        GetPreset(e);
        PresetLoadAnim_Animation(ui_BtnPreset2, 0);
    }
    if(event_code == LV_EVENT_LONG_PRESSED) {
        SetPreset(e);
        PresetSaveAnim_Animation(ui_BtnPreset2, 0);
    }
}
...
void ui_event_BtnSetup(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Setup, LV_SCR_LOAD_ANIM_MOVE_LEFT, 1000, 0, &ui_Setup_screen_init);
    }
}
...
void ui_event_BtnAbout(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_About, LV_SCR_LOAD_ANIM_MOVE_TOP, 1000, 0, &ui_About_screen_init);
    }
}
...
void ui_event_About(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_Config, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 1000, 0, &ui_Config_screen_init);
    }
}
