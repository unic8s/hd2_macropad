...
extern lv_obj_t * ui_WeaponsE;
void ui_event_WeaponsSG(lv_event_t * e);
extern lv_obj_t * ui_WeaponsSG;
extern lv_obj_t * ui_Special;
...
void ui_event_WeaponsEN(lv_event_t * e);
extern lv_obj_t * ui_WeaponsEN;
...
void ui_event_BackpacksGDK(lv_event_t * e);
extern lv_obj_t * ui_BackpacksGDK;
...
void ui_event_StationaryLS(lv_event_t * e);
extern lv_obj_t * ui_StationaryLS;
...
void ui_event_StationaryGB(lv_event_t * e);
extern lv_obj_t * ui_StationaryGB;
void ui_event_StationarySS(lv_event_t * e);
extern lv_obj_t * ui_StationarySS;
...
extern lv_obj_t * ui_CntConnection;
...
extern lv_obj_t * ui_CustomStratagem6;
...
// CUSTOM VARIABLES
extern lv_obj_t * uic_CntConnection;
...
extern lv_obj_t * ui_Display_Audio;
...
LV_IMG_DECLARE(ui_img_sg_e1_png);    // assets/sg/E1.png
LV_IMG_DECLARE(ui_img_sg_sg1_png);    // assets/sg/SG1.png
...
LV_IMG_DECLARE(ui_img_sg_en1_png);    // assets/sg/EN1.png
...
LV_IMG_DECLARE(ui_img_sg_de1_png);    // assets/sg/DE1.png
...
LV_IMG_DECLARE(ui_img_sg_ls1_png);    // assets/sg/LS1.png
...
LV_IMG_DECLARE(ui_img_sg_gb1_png);    // assets/sg/GB1.png
LV_IMG_DECLARE(ui_img_sg_ss1_png);    // assets/sg/SS1.png
...
LV_IMG_DECLARE(ui_img_sg_de2_png);    // assets/sg/DE2.png
...
LV_IMG_DECLARE(ui_img_sg_e2_png);    // assets/sg/E2.png
...
LV_IMG_DECLARE(ui_img_sg_en2_png);    // assets/sg/EN2.png
...
LV_IMG_DECLARE(ui_img_sg_gb2_png);    // assets/sg/GB2.png
LV_IMG_DECLARE(ui_img_sg_gd2_png);    // assets/sg/GD2.png
LV_IMG_DECLARE(ui_img_sg_gdb2_png);    // assets/sg/GDB2.png
LV_IMG_DECLARE(ui_img_sg_gdk2_png);    // assets/sg/GDK2.png
...
LV_IMG_DECLARE(ui_img_sg_hp2_png);    // assets/sg/HP2.png
...
LV_IMG_DECLARE(ui_img_sg_ls2_png);    // assets/sg/LS2.png
...
LV_IMG_DECLARE(ui_img_sg_otf2_png);    // assets/sg/OTF2.png
...
LV_IMG_DECLARE(ui_img_sg_ph2_png);    // assets/sg/PH2.png
...
LV_IMG_DECLARE(ui_img_sg_sg2_png);    // assets/sg/SG2.png
...
LV_IMG_DECLARE(ui_img_sg_ss2_png);    // assets/sg/SS2.png
